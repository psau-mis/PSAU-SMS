...
class AuditlogLog(models.Model):
    ...
    method_display = fields.Char(compute="_compute_method_display", string="Method")
    ...
    def _compute_method_display(self):
        """Changes label for unlink to delete, else returns the rest"""
        for record in self:
            if record.method == 'unlink':
                record.method_display = 'delete'
            else:
                record.method_display = record.method
