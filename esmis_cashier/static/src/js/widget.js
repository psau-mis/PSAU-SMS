...
export class TestX2ManyField extends X2ManyField {
	...
	async applySelected(){
		...
		var self = this;
			...
			// 					model: 'esmis.enrollment',
			// 					method: 'apply_scholar',
			// 					args: [{}],
...
TestX2ManyField.template = "one2many_multi_select.One2manySelect";


registry.category("fields").add("one2many_select", TestX2ManyField);
